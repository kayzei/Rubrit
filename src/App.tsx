  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#1A1A1A] font-sans selection:bg-emerald-100 selection:text-emerald-900">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-emerald-600 font-semibold">Enterprises Ltd</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button className="bg-zinc-900 text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-emerald-600 transition-all shadow-lg shadow-zinc-200 hover:shadow-emerald-200">
                Get a Quote
              </button>
            </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-grid-cols-2 gap-12 items-center">
            <motion.div
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
                Driven by <span className="text-emerald-600">Excellence</span>, Sustained by Integrity.
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-semibold hover:bg-emerald-700 transition-all flex items-center gap-2 shadow-xl shadow-emerald-200">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <FileText className="w-5 h-5 text-emerald-600" /> Profile
                  </button>
                  <button 
                    className="bg-white border border-zinc-200 text-zinc-900 px-6 py-4 rounded-2xl font-semibold hover:bg-zinc-50 transition-all flex items-center gap-2"
                    title="Download Brochure"
                  >
                    <Download className="w-5 h-5 text-emerald-600" /> Brochure
                  </button>
                </div>
              </div>
            </motion.div>
      ...
      <section id="about" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-emerald-600 mb-4">Company Overview</h2>
              <h3 className="text-4xl font-bold mb-8 tracking-tight">Building the Future of Zambia's Infrastructure</h3>
              <p className="text-zinc-600 mb-6 leading-relaxed">
                Based in Riverside, Kitwe, Copperbelt Province, we are strategically positioned close to Zambia's mining, manufacturing, and industrial hubs. We offer a broad range of services to both public and private sector clients.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&q=80&w=400" alt="Work 1" className="rounded-2xl w-full aspect-[4/5] object-cover" referrerPolicy="no-referrer" />
              <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&q=80&w=400" alt="Work 2" className="rounded-2xl w-full aspect-[4/5] object-cover mt-8" referrerPolicy="no-referrer" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-emerald-600 mb-4">Our Expertise</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map((service, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group bg-white rounded-3xl overflow-hidden border border-black/5 hover:shadow-2xl hover:shadow-emerald-100 transition-all duration-500"
              >
                ...
                <div className="p-8">
                  ...
                  <button className="mt-8 text-emerald-600 font-bold text-sm flex items-center gap-2 group/btn">
      ...
      <section id="values" className="py-24 bg-zinc-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-emerald-400 mb-4">Core Values</h2>
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-zinc-50 rounded-[3rem] overflow-hidden border border-black/5">
            <div className="grid lg:grid-cols-2">
              <div className="p-12 lg:p-20">
                <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-emerald-600 mb-4">Contact Us</h2>
                ...
                <div className="space-y-8 mb-12">
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-500 text-sm">Plot # 1734, Riverside, Kitwe,<br />Copperbelt Province, Zambia</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-6">
                    <div className="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 shrink-0">
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" className="w-full px-6 py-4 rounded-2xl bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all" placeholder="John Doe" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">Email Address</label>
                      <input type="email" className="w-full px-6 py-4 rounded-2xl bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all" placeholder="john@example.com" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">Service Required</label>
                    <select className="w-full px-6 py-4 rounded-2xl bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all appearance-none">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea rows={4} className="w-full px-6 py-4 rounded-2xl bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all resize-none" placeholder="How can we help you?"></textarea>
                  </div>
                  <button className="w-full bg-emerald-600 text-white py-5 rounded-2xl font-bold hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100">
                    Send Message
                  </button>
                </form>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                {/* Social placeholders */}
                {[1,2,3].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-500 transition-colors cursor-pointer">
            ...
            <div>
              <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-emerald-400">Compliance</h4>
            ...
            <div>
              <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-emerald-400">Location</h4>
              <p className="text-sm text-zinc-400 leading-relaxed">
                Plot # 1734, Riverside,<br />
                Kitwe, Copperbelt Province,<br />
                Zambia
              </p>
            </div>
          </div>
